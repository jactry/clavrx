...
module ACHA_CLAVRX_BRIDGE_MOD
 ...
 type(acha_input_struct), private :: Acha_Input
 type(acha_output_struct), private :: Acha_Output
...
!---------------------------------------------------------------------- 
 subroutine AWG_CLOUD_HEIGHT_BRIDGE()
   ...
   call NULL_ACHA_INPUT_POINTERS()
   call NULL_ACHA_OUTPUT_POINTERS()
 ...
 !-----------------------------------------------------------------------------
 subroutine NULL_ACHA_INPUT_POINTERS()
     ...
     Acha_Input%Tc_Cirrus_Sounder =>   NULL()
 end subroutine NULL_ACHA_INPUT_POINTERS
 !-----------------------------------------------------------------------------
 ! Nullify the pointers holding output to ACHA
 !-----------------------------------------------------------------------------
 subroutine NULL_ACHA_OUTPUT_POINTERS()
 ...
 end subroutine NULL_ACHA_OUTPUT_POINTERS
 !-----------------------------------------------------------------------------
 ...
 subroutine SET_INPUT()
   ...
   Acha_Input%Tc_Cirrus_Sounder =>  Tc_Cirrus_Co2
