...
!-------------------------------------------------------------------------
 subroutine POPULATE_PLANCK_TABLES(a1_20,a2_20,nu_20, &
  ...
  if (Sensor%Chan_On_Flag_Default(20) == sym%YES) B20 = c1*(nu_20**3)/(exp((c2*nu_20)/((T_Planck-a1_20)/a2_20))-1.0)
  if (Sensor%Chan_On_Flag_Default(21) == sym%YES) B21 = c1*(nu_21**3)/(exp((c2*nu_21)/((T_Planck-a1_21)/a2_21))-1.0)
  if (Sensor%Chan_On_Flag_Default(22) == sym%YES) B22 = c1*(nu_22**3)/(exp((c2*nu_22)/((T_Planck-a1_22)/a2_22))-1.0)
  if (Sensor%Chan_On_Flag_Default(23) == sym%YES) B23 = c1*(nu_23**3)/(exp((c2*nu_23)/((T_Planck-a1_23)/a2_23))-1.0)
  if (Sensor%Chan_On_Flag_Default(24) == sym%YES) B24 = c1*(nu_24**3)/(exp((c2*nu_24)/((T_Planck-a1_24)/a2_24))-1.0)
  if (Sensor%Chan_On_Flag_Default(25) == sym%YES) B25 = c1*(nu_25**3)/(exp((c2*nu_25)/((T_Planck-a1_25)/a2_25))-1.0)
  if (Sensor%Chan_On_Flag_Default(27) == sym%YES) B27 = c1*(nu_27**3)/(exp((c2*nu_27)/((T_Planck-a1_27)/a2_27))-1.0)
  if (Sensor%Chan_On_Flag_Default(28) == sym%YES) B28 = c1*(nu_28**3)/(exp((c2*nu_28)/((T_Planck-a1_28)/a2_28))-1.0)
  if (Sensor%Chan_On_Flag_Default(29) == sym%YES) B29 = c1*(nu_29**3)/(exp((c2*nu_29)/((T_Planck-a1_29)/a2_29))-1.0)
  if (Sensor%Chan_On_Flag_Default(30) == sym%YES) B30 = c1*(nu_30**3)/(exp((c2*nu_30)/((T_Planck-a1_30)/a2_30))-1.0)
  if (Sensor%Chan_On_Flag_Default(31) == sym%YES) B31 = c1*(nu_31**3)/(exp((c2*nu_31)/((T_Planck-a1_31)/a2_31))-1.0)
  if (Sensor%Chan_On_Flag_Default(32) == sym%YES) B32 = c1*(nu_32**3)/(exp((c2*nu_32)/((T_Planck-a1_32)/a2_32))-1.0)
  if (Sensor%Chan_On_Flag_Default(33) == sym%YES) B33 = c1*(nu_33**3)/(exp((c2*nu_33)/((T_Planck-a1_33)/a2_33))-1.0)
  if (Sensor%Chan_On_Flag_Default(34) == sym%YES) B34 = c1*(nu_34**3)/(exp((c2*nu_34)/((T_Planck-a1_34)/a2_34))-1.0)
  if (Sensor%Chan_On_Flag_Default(35) == sym%YES) B35 = c1*(nu_35**3)/(exp((c2*nu_35)/((T_Planck-a1_35)/a2_35))-1.0)
  if (Sensor%Chan_On_Flag_Default(36) == sym%YES) B36 = c1*(nu_36**3)/(exp((c2*nu_36)/((T_Planck-a1_36)/a2_36))-1.0)
  if (Sensor%Chan_On_Flag_Default(37) == sym%YES) B37 = c1*(nu_37**3)/(exp((c2*nu_37)/((T_Planck-a1_37)/a2_37))-1.0)
  if (Sensor%Chan_On_Flag_Default(38) == sym%YES) B38 = c1*(nu_38**3)/(exp((c2*nu_38)/((T_Planck-a1_38)/a2_38))-1.0)
  if (Sensor%Chan_On_Flag_Default(42) == sym%YES) B42 = c1*(nu_42**3)/(exp((c2*nu_42)/((T_Planck-a1_42)/a2_42))-1.0)
  if (Sensor%Chan_On_Flag_Default(43) == sym%YES) B43 = c1*(nu_43**3)/(exp((c2*nu_43)/((T_Planck-a1_43)/a2_43))-1.0)
