...
program DRIVE_SUBSET_LEVEL2B
 ...
 character(len=128):: Path_Input
 character(len=128):: File_Input
 character(len=128):: Path_Output
 character(len=128):: File_Output
 character(len=128):: Data_Description_String
 character(len=128),dimension(:), allocatable:: Sds_Output_Names
 integer(kind=int4):: Nsds_Out
 integer(kind=int4):: Num_Files
 character(len=128), dimension(:), allocatable:: Files
