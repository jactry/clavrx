...
integer, parameter, private:: Habit_Idx = 9  ! 1(droxtals),2(solid_bullet_rosettes),3(hollow_bullet_rosettes),  $
                                             ! 4(solid_columns),5(hollow_columns),6(plates),7(aggregate_columns), $
                                             ! 8(small_aggregate_plates),9(large_aggregate_plates),10(two-habit), $
                                             ! other index(empirical)
...
public:: SETUP_ICE_MICROPHYSICAL_MODEL
  ...
  subroutine SETUP_ICE_MICROPHYSICAL_MODEL(WMO_Id)
   ...
   select case(WMO_Id)
     ...
     case(173)  ! AHI
        include 'acha_ice_cloud_microphysical_model_ahi.inc'
