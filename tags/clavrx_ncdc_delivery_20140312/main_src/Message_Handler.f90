...
!
! NAME: Message_Handler.f90 (src)
!       Message_Handler (program)
!
! PURPOSE: Module to define simple error/exit codes
!          and output messages.
!
! DESCRIPTION:
!
...
MODULE Message_Handler
  ...
  INTEGER,      PARAMETER :: MAX_N_STATES = 7
...
CONTAINS
  ...
  RECURSIVE SUBROUTINE Display_Message(Routine_Name, &
    ...
    IF ( Error_State < 0 .OR. Error_State > MAX_N_STATES ) THEN
      Error_State_To_Use = sym%UNDEFINED
    END IF
