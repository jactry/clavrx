...
# $Header: https://svn.ssec.wisc.edu/repos/cloud_team_clavrx/trunk/clavrx_scripts/install_clavrx.sh 9 2014-01-31 08:19:35Z awalther $
#!/bin/bash
#
...
svn checkout -q https://svn.ssec.wisc.edu/repos/cloud_team_clavrx/branches/dev_for_new_dcomp_interface clavrx

svn checkout -q https://svn.ssec.wisc.edu/repos/cloud_team_dcomp/branches/snow_developments cloud_team_dcomp
