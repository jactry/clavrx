! $Header: https://svn.ssec.wisc.edu/repos/cloud_team_nlcomp/trunk/hdf_dcomp_awg.f90 8 2014-01-31 08:14:58Z awalther $
...
!IF (Idx_chn .EQ. VIS_CHN_NUMBER) Idx_Chn_LUT = 1
!IF (Idx_chn .EQ.  IR_CHN_NUMBER_3A) Idx_Chn_LUT = 2
!IF (Idx_chn .EQ.  IR_CHN_NUMBER_3B) Idx_Chn_LUT = 3
