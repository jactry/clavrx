!$Id: modis_module.f90,v 1.7.2.2 2014/01/26 04:48:34 heidinger Exp $
!--------------------------------------------------------------------------------------
...
module MODIS_MODULE
 ...
 public:: READ_MODIS_LEVEL1B
 public:: READ_MODIS_LEVEL1B_GEOLOCATION
 public:: READ_MODIS_LEVEL1B_CLOUD_MASK
...
subroutine READ_MODIS(Seg_Idx,Error_Status)
    ...
    Eff_Wavenumber = (/Nu_20, Nu_21, Nu_22, Nu_23, Nu_24, Nu_25, Missing_Value_Real4,  &
                       Nu_27, Nu_28, Nu_29, Nu_30, Nu_31, Nu_32, Nu_33, Nu_34, Nu_35, Nu_36/)
